...
class model(object):
    def __init__(self, opt, **kwargs):
        ...
        show_config(dataset_path = self.dataset_path.split('/')[-2], model_path = self.model_path, int_shape = self.input_shape)

    #---------------------------------------------------#
    #   获得所有的分类
    #---------------------------------------------------#
    def generate(self, onnx=False):
        self.net = MRF3Net(num_classes = self.num_classes, Train=False)
